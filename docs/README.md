...
- **Minimum funding to create a commitment:** arming a commitment requires available balance ≥ **Rs. 200** (configurable); **max penalty/forfeit exposure capped to the pre-funded/staked balance at creation** — no money, no commitment. Underfunded → `402 COMMITMENT_FUNDING_REQUIRED`. See [product/prd.md](product/prd.md) FR-6.
